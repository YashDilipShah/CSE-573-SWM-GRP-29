...
document.addEventListener('DOMContentLoaded', function () {
    ...
    d3.csv('output.csv')
        .then((data) => {
            ...
            var selectElement = document.querySelector('#select-id select');
...
container.style.marginRight = '20px';  // Margin to move it to the right
...
// Append container to the parent element (stateSelect)
stateSelect.appendChild(container);
...
const drawBarChart = (data) => {
    ...
    const bars = g.selectAll('.allLines')
        .data(visData);
    ...
    bars.join('line')
        ...
        .attr('y2', yScale(0))
        .attr('stroke', (d, i) => d3.schemeCategory10[i % 10]) // Use a different color for each bar
